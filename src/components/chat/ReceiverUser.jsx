      ...
      <div className=" flex flex-col items-center justify-between pt-2 " >
         <div className=" flex w-full justify-between items-center " >
            <div className=" flex justify-center items-center gap-3 " >
               <img src={messageContext.userReceiver.image} className=" rounded-full w-14" />
               <div>
                  <div className=" font-bold text-xl " >{messageContext.userReceiver.name}</div>
         ...
         <div className=" w-full h-[1px] bg-black mt-4 mb-4 bg-opacity-20 " >
