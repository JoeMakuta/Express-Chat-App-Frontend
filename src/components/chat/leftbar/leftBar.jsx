    ...
    <section className=" border-r-[1px] border-black/10 flex flex-col justify-start items-start pt-4  min-h-full w-[25%] min-w-[300px] gap-3 ">
      <div className=" flex w-[90%] self-center justify-center items-center relative gap-2  outline-none ">
        ...
        <input
          type="text"
          className={
            " bg-slate-700/10 p-3 pl-7 h-8 rounded-md outline-none focus:border-none focus:border-0 text-xs focus:shadow-none " +
            inputStyles
          }
          placeholder="Search ... "
        />
      ...
      <div
        id="style-4"
        className=" text-sm w-full flex flex-col overflow-x-scroll  "
      >
