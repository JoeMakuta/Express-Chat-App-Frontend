...
const sideMenu = () => {
  ...
  return (
    <div className=" flex sm:relative bottom-0 sm:flex-col bg-black w-full sm:w-24 bg-opacity-10 justify-between items-center h-fit sm:h-[100vh] pb-10">
            ...
            <div
              ...
              className={
                elt.name == selectedMenu
                  ? "cursor-pointer w-14 h-14 flex justify-center items-center rounded-full bg-person_background "
                  : "cursor-pointer w-14 h-14 flex justify-center items-center rounded-full hover:bg-person_background hover:bg-opacity-20 "
              }
              onClick={() => {
      ...
      <div className="hidden sm:flex justify-center items-center sm:flex-col sm:gap-10 ">
        ...
        <div className=" flex  flex-col gap-3 justify-center items-center sm:pt-6 ">
          <img
            ...
            alt=""
          />
          <div className=" text-center leading-5 font-bold ">
